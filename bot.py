...
class Bot(commands.Bot):
    ...
    def __init__(self, prefix, *, intents):
        ...
        self.db: AsyncIOMotorDatabase = init_db(os.getenv('MONGO_HOSTNAME'), int(os.getenv('MONGO_PORT')), os.getenv('MONGO_DB'), os.getenv('MONGO_USERNAME'), os.getenv('MONGO_PASSWORD'))
